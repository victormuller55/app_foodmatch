...
import 'package:app_foodmatch/pages/fisica/menu/reservas/reservas_page.dart';
  ...
  return Drawer(
    child: Column(
      children: [
        ...
        _menu(title: 'Home', icon: Icons.home, page: MenuPage()),
        _menu(
        ...
        _menu(
          title: 'Configurações',
          icon: Icons.settings,
          page: ConfiguracaoPage(isJuridico: false),
        ),
        _menu(
          title: 'Sair da Conta',
          icon: Icons.logout,
